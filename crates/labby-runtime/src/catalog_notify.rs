...
/// `gateway.mcp_apps.set` changed one or more Labby-owned MCP App visibility
/// switches without rebuilding the upstream pool.
pub const SOURCE_GATEWAY_MCP_APPS_SET: &str = "gateway.mcp_apps.set";
