...
trait; any future server (e.g. a media/Retired upstream server that scripts REST APIs via
...
- [ ] **Task 6 — Docs + dead-doc cleanup.** Author `lab-codemode/CLAUDE.md`
  ...
  CLAUDE.md "search() entry point", the root CLAUDE.md retired-upstream/retired-upstream references,
...
- The ten REST service clients (retired-upstream/retired-upstream/retired-upstream/retired-upstream/retired-upstream/retired-upstream/
  retired-upstream/retired-upstream/retired-upstream/retired-upstream) and the native-dispatch `CodeModeHost`
