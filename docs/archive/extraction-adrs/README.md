# Historical Extraction Architecture Decision Records

These ADRs record the earlier Lab-to-Labby crate extraction and packaging decisions. They are preserved for historical context and are not the source of truth for the current workspace boundaries. See `docs/TECH.md`, `docs/ARCH.md`, and the current crate manifests for shipped architecture.
