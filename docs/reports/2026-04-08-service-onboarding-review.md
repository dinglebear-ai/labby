...
- Retired upstream uses a bespoke typed CLI
...
Retired upstream is the best expression of this pattern because its SDK is split by resource modules instead of growing into one giant client file.

Relevant files:

- [client.rs](/home/jmagar/workspace/lab/crates/lab-apis/src/retired-upstream/client.rs)
...
- [retired-upstream.rs](/home/jmagar/workspace/lab/crates/lab/src/api/services/retired-upstream.rs)
...
The Retired upstream, ByteStash, and UniFi HTTP API handlers all follow the same structure:
...
- [retired-upstream.rs](/home/jmagar/workspace/lab/crates/lab/src/api/services/retired-upstream.rs#L12)
...
- [retired-upstream.rs](/home/jmagar/workspace/lab/crates/lab/src/api/services/retired-upstream.rs#L13)
...
- Retired upstream: historical `crates/lab/src/mcp/services/retired-upstream.rs`
...
Retired upstream uses a bespoke typed subcommand tree:

- [retired-upstream.rs](/home/jmagar/workspace/lab/crates/lab/src/cli/retired-upstream.rs#L18)
...
UniFi and Retired upstream in particular are already large action-switch modules:

- historical `crates/lab/src/mcp/services/unifi.rs`
- historical `crates/lab/src/mcp/services/retired-upstream.rs`

This is survivable for a while, but it is the next likely maintainability pressure point. Retired upstream’s SDK already solved this pattern well by splitting endpoint logic by resource. MCP may eventually need a lighter version of that organization.
