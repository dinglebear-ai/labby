...
Operator setup: how to generate (`openssl rand -base64 32`), where to store (`~/.lab/.env`), key-rotation strategy (delete creds, re-authorize). Document failure mode: missing key blocks startup.
