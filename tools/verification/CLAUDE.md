# tools/verification/ — Verification Toolkit Rules
...
[docs/dev/VERIFICATION.md](../../docs/dev/VERIFICATION.md).
...
- `[workspace.lints.clippy]` in `tools/verification/Cargo.toml` mirrors the root
