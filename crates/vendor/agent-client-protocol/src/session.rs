    ...
    Link: HasPeer<Agent>,
{
    ...
    #[cfg(feature = "unstable_session_model")]
    models: Option<crate::schema::SessionModelState>,
    ...
    Link: HasPeer<Agent>,
{
    ...
    /// Access models available in this session.
    #[cfg(feature = "unstable_session_model")]
    pub fn models(&self) -> &Option<crate::schema::SessionModelState> {
        &self.models
    }
    ...
    pub fn response(&self) -> NewSessionResponse {
        let response = NewSessionResponse::new(self.session_id.clone())
            .modes(self.modes.clone())
            .meta(self.meta.clone());
        #[cfg(feature = "unstable_session_model")]
        let response = response.models(self.models.clone());
        response
    }
