...
- `~/docs/homelab/proxies.md` still shows `lab.tootie.tv → 100.88.16.79:8765` (pre-Incus route) — regenerate the homelab sidecars when convenient.

## Next Steps

1. Power-cycle **squirts** — the SWAG edge is still hard down; until then use `http://100.88.16.79:40100` for the gateway.
