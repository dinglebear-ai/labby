...
| `gateway` | `gateway.enrich.status` | false | false | true | lab:admin | `resource_capability` | `platform.manage` | `gateway` |  | `GatewayEnrichmentStatusView` | cli, mcp, api |
...
| `tasks` | `tasks.schedule_create` | false | false | false |  | `resource_capability` | `scope.create` | `task` | `schedule_id*: string`<br>`name*: string`<br>`owner_kind*: string`<br>`owner_id*: string`<br>`agent_id*: string`<br>`input*: string`<br>`schedule*: string`<br>`project_id: string`<br>`armed: string`<br>`retry_policy: string` | `object` | mcp, api |
| `tasks` | `tasks.schedule_delete` | false | false | false |  | `resource_capability` | `scope.delete` | `task` | `schedule_id*: string` | `object` | mcp, api |
| `tasks` | `tasks.schedule_edit` | false | false | false |  | `resource_capability` | `scope.operate` | `task` | `schedule_id*: string`<br>`name: string`<br>`agent_id: string`<br>`input: string`<br>`schedule: string`<br>`retry_policy: string` | `object` | mcp, api |
