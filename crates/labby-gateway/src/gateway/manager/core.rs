...
impl GatewayManager {
    ...
    pub fn try_with_store(
        ...
        Ok(Self {
            ...
            transient_oauth_managers: Arc::new(Mutex::new(std::collections::HashMap::new())),
            transient_oauth_sweeper_started: Arc::new(std::sync::atomic::AtomicBool::new(false)),
            transient_oauth_sweeper_owner: Arc::new(()),
            ...
            oauth_status_subject_epochs: Arc::new(dashmap::DashMap::new()),
            oauth_status_upstream_epochs: Arc::new(dashmap::DashMap::new()),
            oauth_status_next_epoch: Arc::new(AtomicU64::new(1)),
            oauth_status_connect_bulkhead: Arc::new(tokio::sync::Semaphore::new(64)),
