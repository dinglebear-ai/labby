...
CREATE UNIQUE INDEX stash_pending_owner_name ON pending_uploads(owner_principal_id,collision_key); CREATE INDEX stash_pending_janitor ON pending_uploads(state,expires_at,upload_id);
