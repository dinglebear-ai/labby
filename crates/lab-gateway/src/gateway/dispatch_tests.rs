...
use lab_runtime::gateway_config::{ProtectedMcpRouteConfig, UpstreamConfig};
...
async fn protected_gateway_subset_hot_crud_requires_restart() {
    ...
    manager
        .seed_config(lab_runtime::gateway_config::GatewayConfig {
            ...
            ..lab_runtime::gateway_config::GatewayConfig::default()
        })
        .await;
...
async fn virtual_server_policy_validation_uses_service_name() {
    ...
    manager
        .seed_config(lab_runtime::gateway_config::GatewayConfig {
            virtual_servers: vec![lab_runtime::gateway_config::VirtualServerConfig {
    ...
    manager
        .seed_config(lab_runtime::gateway_config::GatewayConfig {
            virtual_servers: vec![lab_runtime::gateway_config::VirtualServerConfig {
                ...
                service: "deploy".to_string(),
                enabled: true,
                surfaces: lab_runtime::gateway_config::VirtualServerSurfacesConfig {
                    mcp: true,
                    ..lab_runtime::gateway_config::VirtualServerSurfacesConfig::default()
                },
                mcp_policy: None,
            }],
            ..lab_runtime::gateway_config::GatewayConfig::default()
...
async fn virtual_server_quarantine_list_and_restore_round_trip() {
    ...
    manager
        .seed_config(lab_runtime::gateway_config::GatewayConfig {
            quarantined_virtual_servers: vec![lab_runtime::gateway_config::VirtualServerConfig {
                id: "deploy".to_string(),
                service: "deploy".to_string(),
                enabled: true,
                surfaces: lab_runtime::gateway_config::VirtualServerSurfacesConfig {
...
fn shape_http_server_gets_http_transport_no_command_preview() {
    ...
    let cfg = lab_runtime::gateway_config::GatewayConfig::default();
