...
export function ArtifactWorkspaceSwitch({ value, onChange, tabs = false }: {
  ...
  return <div role="group" aria-label="Creation workspace" className={tabs ? 'flex h-[38px] gap-0.5 rounded-b-aurora-3 border-t border-aurora-border-default/55 bg-[var(--gw0-0_30)] px-5' : 'flex shrink-0 gap-[3px] rounded-full border border-aurora-border-default bg-aurora-control-surface p-[3px]'}>
