...
p.add_argument("--npm-pointer-rc", type=int, default=0)
...
all_ok = a.pointer_rc == a.github_rc == a.npm_pointer_rc == 0 and not npm_published and not mcp_published
payload = {
    "status": "ok" if all_ok else "failed",
    "npm_pointer": {"status": "ok" if a.npm_pointer_rc == 0 else "failed", "exit_code": a.npm_pointer_rc},
