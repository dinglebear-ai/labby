...
function applyRuntimeRow(gateway: Gateway, runtime: BackendGatewayMcpRuntimeView | undefined): Gateway {
  ...
  return {
    ...
    status: {
      ...
      server_name: runtime.server_name ?? gateway.status.server_name,
      server_version: runtime.server_version ?? gateway.status.server_version,
      protocol_version: runtime.protocol_version ?? gateway.status.protocol_version,
