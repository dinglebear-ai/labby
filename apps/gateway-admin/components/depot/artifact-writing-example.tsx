...
export function ArtifactWritingExample({ kind }: { kind: ArtifactKind }) {
  return <section aria-label={`Writing example for ${kind}`} className="overflow-hidden rounded-aurora-2 border border-aurora-border-default bg-[linear-gradient(180deg,var(--aurora-panel-strong-top),var(--aurora-panel-strong))] shadow-aurora-medium">
