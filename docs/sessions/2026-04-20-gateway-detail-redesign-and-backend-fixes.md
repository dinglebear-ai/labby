...
| Area | Before | After |
|------|--------|-------|
| Resource URIs | Re-probe doubled prefix: `lab://upstream/retired-upstream/lab://upstream/retired-upstream/...` | Prefix applied once; guard skips rewrite if already prefixed |
| Duplicate gateway POST | Returns 422 `invalid_param` | Returns 409 `{"kind":"conflict","message":"...","existing_id":"retired-upstream"}` |
