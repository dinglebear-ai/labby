//! Reject ambiguity before opaque Value payloads lose duplicate object keys.
    ...
    fn deserialize<D: Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        impl<'de> Visitor<'de> for UniqueVisitor {
            ...
            fn expecting(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
                formatter.write_str("JSON with unique object keys at every depth")
            }
            ...
            fn visit_map<A: MapAccess<'de>>(self, mut source: A) -> Result<Self::Value, A::Error> {
                ...
                while let Some(key) = source.next_key::<String>()? {
                    ...
                    map.insert(key, source.next_value::<UniqueValue>()?.0);
                }
