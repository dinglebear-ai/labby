...
pub use lab_codemode::run_code_mode_runner_stdio;
pub use lab_codemode::{
...
pub(crate) use lab_codemode::split_namespaced_id as split_upstream_tool;
...
pub(crate) struct SnippetMetadataCache {
    pub fingerprint: String,
    pub entries: Vec<lab_codemode::snippet::store::SnippetInfo>,
}
