...
pub(crate) const HOOK_ACTIONS: [ActionSpec; 14] = [
    spec(
        "hook_library.list",
        "List caller-visible stored Hook summaries",
        false,
        false,
        "VersionedHookLibraryPage",
        PAGE,
    ),
    spec(
        "hook_library.get",
        "Get one stored Hook summary without bodies",
        false,
        false,
        "VersionedHookLibrarySummary",
        &[ARTIFACT],
    ),
    spec(
        "hook_library.read",
        "Read one exact immutable Hook declaration",
        false,
        false,
        "VersionedRevisionFile",
        &[
            ...
            ParamSpec {
                ...
                ty: "string",
                required: true,
                description: "HOOK.json",
            },
        ],
    ),
    spec(
        "hook_library.history",
        "List immutable Hook revisions",
        false,
        false,
        "VersionedRevisionPage",
        HISTORY_PARAMS,
    ...
    spec(
        "hook_library.diff",
        "Compare two immutable Hook revisions",
        false,
        false,
        "ArtifactRevisionDiff",
        &[
    ...
    spec(
        "hook_library.validate",
        "Validate Hook event and execution policy without persistence",
        false,
        false,
        "HookValidation",
        &[
    ...
    spec(
        "hook_library.preview",
        "Return inert Hook declaration text without executing it",
        false,
        false,
        "HookPreview",
        &[
    ...
    spec(
        "hook_library.create",
        "Create an inactive Hook workspace and immutable revision",
        false,
        false,
        "HookMutationReceipt",
        &[
    ...
    spec(
        "hook_library.save",
        "Save a new immutable Hook revision without activation",
        false,
        false,
        "HookMutationReceipt",
        &[ARTIFACT, REVISION, FILES, VERSION, IDEM],
    ...
    spec(
        ...
        "Explicitly activate an exact validated Hook revision",
        false,
        false,
        "HookMutationReceipt",
        &[ARTIFACT, REVISION, VERSION, IDEM],
    ...
    spec(
        ...
        "Deactivate a Hook while retaining revisions",
        false,
        false,
        "HookMutationReceipt",
        &[ARTIFACT, VERSION, IDEM],
    ...
    spec(
        ...
        "Archive a Hook while retaining referenced revisions",
        true,
        false,
        "HookMutationReceipt",
        &[ARTIFACT, VERSION, IDEM],
    ...
    spec(
        ...
        "Restore an archived Hook as inactive",
        false,
        false,
        "HookMutationReceipt",
        &[ARTIFACT, VERSION, IDEM],
    ...
    spec(
        ...
        "Explicitly activate a prior immutable Hook revision",
        false,
        false,
        "HookMutationReceipt",
        &[ARTIFACT, REVISION, VERSION, IDEM],
