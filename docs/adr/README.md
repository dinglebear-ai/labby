...
| [0006](./0006-operator-complete-mcp-observability.md) | Accepted | Adopt operator-complete MCP observability, client/network attribution, and protected forensic capture |
