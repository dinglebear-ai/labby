...
- [x] **Wave 52 / Milestone 0BD transport-bound exact Tool wrapper:** validate the immutable middleware-owned token expiry and identity before and after Wave 51 execution, derive route facts only from the bound core, and remain unmounted until Task/InputRequired negotiation and follow-up are solved. Tracked under `lab-0k1wm`.
