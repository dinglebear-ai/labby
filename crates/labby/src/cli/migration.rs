...
pub const MOVED: &[(&str, &str)] = &[
    ...
    ("setup installed-plugins", "plugin list"),
    ("setup services-status", "config status"),
    ("setup plugin-hook", "plugin hook"),
    ("setup plugin-sync", "plugin sync"),
    ("setup plugin-export", "plugin export"),
    ("setup plugin-connectivity", "plugin check"),
    ("setup install-plugin", "plugin install"),
    ("setup uninstall-plugin", "plugin uninstall"),
