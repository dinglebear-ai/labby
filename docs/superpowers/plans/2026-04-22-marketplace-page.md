...
const MOCK_PLUGINS: Plugin[] = [
  ...
  // jmagar-lab
  { id: 'lab@jl', name: 'lab', mkt: 'jmagar-lab', ver: '0.7.0', desc: 'Homelab control plane — CLI, MCP server, HTTP API for 24 services (ExampleMovies, ExampleSeries, ExampleMedia, UniFi, Unraid, and more).', tags: ['homelab', 'mcp', 'cli', 'rust'], installed: true, installedAt: '2026-04-21', updatedAt: '2026-04-22' },
]
