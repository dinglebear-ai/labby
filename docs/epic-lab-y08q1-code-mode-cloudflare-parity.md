...
- Javy: prepend `const __upstreams__ = ["example-upstream","example-upstream","example-upstream"];` to preamble
...
| Namespace format | Flat `declare const codemode: { toolName: ... }` | Nested `declare namespace codemode { namespace example-upstream { ... } }` | Preserves upstream identity, better tab-completion |
