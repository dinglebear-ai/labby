...
test('overview cards retain every Depot workspace action in the compact layout', async () => {
  ...
  try {
    ...
    assert.equal(view.container.querySelectorAll('h2').length, 5)
    ...
    assert.deepEqual(selected, ['sources', 'artifacts', 'catalog', 'access', 'operations'])
