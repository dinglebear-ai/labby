...
This folder preserves the target contract for complete-window, scalable, and
drillable gateway usage analytics. The core implementation landed in PR #459
while the original plan was in progress. The remaining work is intentionally
kept separate from claims about what is available today.
