...
# Verify Labby's production rmcp pin, then run the pinned upstream rmcp
# fixture against the 2026-07-28 dated protocol, Labby-native multi-hop
# proxying, and separately scored extension scenarios. Dated and extension
# failures use independent strict baselines.
#
