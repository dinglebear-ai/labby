...
- Modify: selected dispatch entrypoints (`retired-upstream`, `linkding`, `paperless`, `retired-upstream`, `unifi`, `lab_admin`) to preserve useful tests from deleted wrappers.
...
```rust
crate::dispatch::retired-upstream::actions()
...
- Modify: `crates/lab/src/dispatch/retired-upstream.rs`
...
```rust
// retired-upstream: core read-only actions in actions()
// linkding: full core catalog and destructive bookmark.delete
// paperless: full resource catalog smoke check
// retired-upstream: full core catalog and destructive actions
...
```bash
rg -n "mcp::services::(apprise|arcane|bytestash|doctor|extract|gateway|gotify|lab_admin|linkding|logs|marketplace|memos|openai|retired-upstream|paperless|retired-upstream|retired-upstream|retired-upstream|qdrant|retired-upstream|retired-upstream|retired-upstream|tei|unifi)|crate::mcp::services::(apprise|arcane|bytestash|doctor|extract|gateway|gotify|lab_admin|linkding|logs|marketplace|memos|openai|retired-upstream|paperless|retired-upstream|retired-upstream|retired-upstream|qdrant|retired-upstream|retired-upstream|retired-upstream|tei|unifi)|crates/lab/src/mcp/services/(apprise|arcane|bytestash|doctor|extract|gateway|gotify|lab_admin|linkding|logs|marketplace|memos|openai|retired-upstream|paperless|retired-upstream|retired-upstream|retired-upstream|qdrant|retired-upstream|retired-upstream|retired-upstream|tei|unifi)\.rs" crates/lab/src docs/coverage docs/SERVICE_ONBOARDING.md docs/SCAFFOLD_AND_AUDIT.md crates/lab/src/mcp/CLAUDE.md
```
...
```bash
cargo test -p lab --all-features registry::tests dispatch::retired-upstream::tests dispatch::linkding::tests dispatch::paperless::tests dispatch::retired-upstream::tests dispatch::unifi::tests dispatch::lab_admin::tests --no-fail-fast
```
