...
| `crates/lab-apis/src/extract/parsers/retired-upstream.rs` | modified | Dirty at save time; exact purpose not re-audited during save. |
...
| `git log --oneline --name-only -10` | Returned recent commit/file history, including Marketplace v2, dev mockup, retired-dev-route, and component-development commits. |
