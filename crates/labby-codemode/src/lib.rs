...
pub use namespace_alias::{
    NamespaceResolution, ambiguous_namespace_message, backtick_list, namespace_alias_key,
    resolve_namespace_alias, similar_namespaces, unknown_namespace_guidance,
};
