...
| `depot_publish` | `depot.publish_skill_archive` | false | false | false |  | `filename*: string`<br>`archive_base64*: string`<br>`namespace: string` | `IngestJobReceipt` | mcp, api |
| `depot_publish` | `help` | true | false | false |  |  | `HelpPayload` | mcp, api |
| `depot_publish` | `schema` | true | false | false |  | `action*: string` | `ActionSpec` | mcp, api |
