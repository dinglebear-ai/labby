...
passes. When proxy policy allows an optional capability but the upstream did
not advertise it during initialize, the gateway does not probe the missing
method; it emits a DEBUG upstream.request.skipped event with
