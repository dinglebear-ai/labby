...
pub struct Tool {
    ...
    /// Optional authentication policies for this tool.
    ///
    /// This extension is intentionally represented as JSON values because it is
    /// not part of the core MCP Tool schema and extension vocabularies may grow
    /// independently. OpenAI currently defines `noauth` and `oauth2` objects.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub security_schemes: Option<Vec<Value>>,
...
impl Tool {
    ...
    /// Set tool-level authentication policies.
    pub fn with_security_schemes(mut self, security_schemes: Vec<Value>) -> Self {
