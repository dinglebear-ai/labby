...
- Release builds, container images, Incus images, publishing, signing, and
  ...
  runners.
- Native Windows CI is GitHub-hosted. Palette Windows checks are required for
  Palette changes; workspace Windows checks remain advisory to `ci-gate`.
...
| native Windows checks | `windows-latest` |
