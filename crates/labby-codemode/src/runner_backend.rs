...
pub(super) fn resolve_runner_spawn() -> Result<RunnerSpawn, ToolError> {
...
fn process_spawn() -> Result<RunnerSpawn, ToolError> {
    Ok(RunnerSpawn {
...
fn microsandbox_spawn() -> Result<RunnerSpawn, ToolError> {
