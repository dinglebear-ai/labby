...
Status: **draft** (plan-stage; promote to `docs/contracts/mcp-tool-output.md` when implemented)
Surfaces: MCP
Related: [spec](SPEC.md), [research](RESEARCH.md), `docs/dev/ERRORS.md`,
`docs/contracts/agent-error-contract.md`, `docs/design/SERIALIZATION.md`
...
- Acceptance criteria live in [SPEC.md](SPEC.md) §6 — this document does not restate them.
